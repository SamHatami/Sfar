...
public class PlanetCreator
{
    ...
    public static PlanetData[] CreatePlanets()
    {
        ...
        if (RandomUtils.Probability(PlanetSettings.GiantProbability))
            planet.Size = random.Next(PlanetSettings.GiantSizeMin, PlanetSettings.GiantSizeMax); //Randomize within
